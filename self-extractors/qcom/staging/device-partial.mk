...
PRODUCT_COPY_FILES := \
     vendor/qcom/bramble/proprietary/qvrd.rc:system/etc/init/qvrd.rc \
     vendor/qcom/bramble/proprietary/6dof_config.xml:system/etc/qvr/6dof_config.xml \
     vendor/qcom/bramble/proprietary/qvrservice_config.txt:system/etc/qvr/qvrservice_config.txt \
     ...
     vendor/qcom/bramble/proprietary/com.qti.snapdragon.sdk.display.jar:system_ext/framework/com.qti.snapdragon.sdk.display.jar \
     ...
     vendor/qcom/bramble/proprietary/vendor.qti.hardware.alarm-V1.0-java.jar:system_ext/framework/vendor.qti.hardware.alarm-V1.0-java.jar \
     ...
     vendor/qcom/bramble/proprietary/QPerformance.jar:system/framework/QPerformance.jar \
     vendor/qcom/bramble/proprietary/UxPerformance.jar:system/framework/UxPerformance.jar \
